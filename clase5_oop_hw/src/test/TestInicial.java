...
public class TestInicial {
	...
	public static void main(String[] args) {
		...
		System.out.println("termometro2 antes del aray: " + termometro2.getIdentificador() + " -- " + termometro2.getUbicacion());
		IAnemometro anemometro1 = new Anemometro("098578", "Argentina");
		System.out.println("anemometro1 antes del aray: " + anemometro1.getIdentificador() + " -- " + anemometro1.getUbicacion());
		IPluviometro pluviometro1 = new Pluviometro("15432", "Brazil");
		System.out.println("pluviometro1 antes del aray: " + pluviometro1.getIdentificador() + " -- " + pluviometro1.getUbicacion());
		//IPluviometro pluviometro2 = new Pluviometro("765437", "Uruguay");

		System.out.println();
		
		System.out.println(termometro1.mostrarDatos());
		System.out.println(termometro2.mostrarDatos());
